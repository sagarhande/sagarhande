...
### 🤵 About Me:
- 🏦 I'm currently working for Velotio Technologies, where I work mostly on  startups.
      <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">
- 🤔 I use daily ```.python```,``` .go```, ```.sql```
...
- 😄 Pronouns: He/Him
- 📝 I regulary write articles on [hashnode](https://sagarhande.tech/) (previously on [blogger](https://apoorvtyagi133.blogspot.com/))
